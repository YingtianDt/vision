...
model_registry["MViT-V2-B-Kinetics400"] = lambda: commit_model("MViT-V2-B-Kinetics400")
model_registry["MViT-V2-B-smthsmthv2"] = lambda: commit_model("MViT-V2-B-smthsmthv2")
